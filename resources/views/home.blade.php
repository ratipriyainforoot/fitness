...
<head>
  ...
  <title>Fitness Way Employee PortaLlll</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="{{route('adminLogin')}}" method="POST">
                    @csrf

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Email</label>
                      <div class="input-group has-validation">
                        <input type="text" name="email" class="form-control" id="yourUsername" placeholder="admin@gmail.com" required>
                        <div class="invalid-feedback">Please enter your email.</div>
                        @php
                           if(session()->has('adminEmailError')) {
                            echo 
